...
class Auth extends React.Component {
    ...
    render() {
        let title = this.state.login ? /*ternary*/ 'Login' : 'Sign Up';
        let signupFields = !this.state.login ? (
            <div>
                ...
                <input className="display-block" type="text" name="lastName" htmlFor="lastName" value={this.state.lastName} onChange={(e) => this.handleChange(e)} />
            </div>
        ) : null;
