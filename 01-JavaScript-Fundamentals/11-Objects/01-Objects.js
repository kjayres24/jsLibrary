...
//to list the episode info and name create a function
...
let spaceJam = {
  ...
  //how to find keys in objects (only want to print out phoenixSuns)
  console.log(Object.keys(spaceJam.nbaPlayers)[0])
  console.log(Object.keys(spaceJam.toonSquad).toString()) //setting the array to a string
  console.log(Object.values(spaceJam.toonSquad)); //to find values in objects
  ...
  console.log(garden.vegetable); //to get 'zucchini'
